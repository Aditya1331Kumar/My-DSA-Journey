...
## 🧠 Step 1: Question ko dekhna

> “Given n and k, return the kth permutation sequence of numbers \[1..n].”

Mere dimaag me turant do options aaye:

1. **Brute force** → saare permutations generate kar lo (via recursion / backtracking), sort kar lo, fir `kth` return kar do.

   * Problem: n=9 ke liye 9! = 362,880 permutations, ye generate karna slow hai.
   * Interviews me brute force chalega nahi.

2. **Smart way** → bina saare permutations generate kiye directly kth banana.

---

## 🧠 Step 2: Pattern samajhna
...
→ Matlab **blocks** ban rahe hain, har digit ke saath ek block.

---

## 🧠 Step 3: “Block thinking”

Ab socha:

* Agar mujhe kth permutation chahiye, mujhe bas yeh pata karna hai ki kth **kaunse block me aata hai**.
* Example: k=4, n=3 → blocks of size 2:

  * Block 1 (1 se start) → \[123,132] (positions 1–2)
  * Block 2 (2 se start) → \[213,231] (positions 3–4)
  * Block 3 (3 se start) → \[312,321] (positions 5–6)

k=4 → Block 2 → first digit = 2. ✅

---

## 🧠 Step 4: Math formula nikalna
...
* Example: n=3, k=4
  `(4-1) / 2! = 3/2 = 1` → second digit of \[1,2,3] = 2.
  Perfect!

---

## 🧠 Step 5: Recursion / iteration sochna
...
* Isko recursive bhi likh sakte the, par iterative likhna zyada clean tha → loop from n to 1.

---

## 🧠 Step 6: Data structures

* Digits ko store karne ke liye ek list chahiye thi → `ArrayList` best.
* Har step pe `nums.remove(index)` karna hai, isliye normal array nahi use kar sakte.

---

## 🧠 Step 7: Final Code Structure
...
Aur bas answer ready 🎯

---

## 🧠 Real dimaag ka flow

* Problem dekha → “saare permutations generate karna possible nahi”.
* Chhote examples likhe → pattern dekha.
