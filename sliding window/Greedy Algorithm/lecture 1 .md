...
**Greedy Algorithm ka matlab:**
 **Har step par jo choice *us moment* pe best lagti hai, wahi choose kar lo — bina future ki tension liye.**
Yani **locally best choice → globally best result** ki hope mein chalna.

## Greedy Algorithm ka Logic Kahan Kaam Karta Hai?

* Jab **local optimum = global optimum** hota hai.


#  Greedy kab kaam nahi karta?

* Jab **future choices ka impact** important hota hai.
* Jaise knapsack 0/1 problem (isme DP chahiye).

---

## Summary

**Greedy = Abhi ka best → future ki chinta nahi.
DP = Abhi ka best + future ka impact dono.**
